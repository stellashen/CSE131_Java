...
public class gambler {
	...
	public static void main(String[] args) {
		...
		if (startAmount >= winAmount){
			System.out.println("Warning: The amount of money that you start with is greater than the amount of money to win. Please try again and enter different numbers.");
			System.out.println();
			warning = true;
		}

		if (winChance < 0 || winChance > 1) {
			System.out.println("Warning: The probability of winning has to be within 0 - 1. Please enter a different number.");
			System.out.println();
			warning = true;
		}
